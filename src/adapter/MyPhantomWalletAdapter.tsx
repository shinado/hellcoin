...
export class MyPhantomWalletAdapter extends BaseMessageSignerWalletAdapter {
  ...
  private isIOS = () => {
    ...
    return /iPad|iPhone|iPod/i.test(userAgent) || (navigator.userAgent.includes('Mac') && 'ontouchend' in document)
  }
